...
BLEDescriptor *pDescriptor1 = new BLEDescriptor((uint16_t)0x2901);
...
void Bleinit() {
  ...
  pCharacteristic = pService->createCharacteristic(CHARACTERISTIC_UUID_T, BLECharacteristic::PROPERTY_READ);
...
void loop() {
  if (_BLEClientConnected) {
    char tstring[8];
    pCharacteristic->setValue("locke");
